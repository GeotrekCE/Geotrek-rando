...
function filtersService($sce, settingsFactory) {
    ...
    this.filterTrekWithSelect = function (selectOptionValues, formValue, fieldToCheck) {
        ...
        for (i = 0; i < selectOptionValues.length; i++) {
            fieldValue = selectOptionValues[i][fieldToCheck];
    ...
    this.removeFilterDuplicates = function (array) {
        ...
        for (y = 0; y < dictKeys.length; y++) {
            result.push(dict[dictKeys[y]]);
        }
