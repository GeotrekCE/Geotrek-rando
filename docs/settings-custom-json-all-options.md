...
RULES_FLAT_PAGES_ID (deprecated) | string | `""` | Specify the rules flat-page id which will be used in the detail page part about the rules.
...
FILTERS_DEFAULT_OPEN | Boolean | `false` | If true, the filters values will be expanded by default.
